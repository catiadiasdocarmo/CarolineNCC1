...
rownames(DataCar) <- as.character(DataCar$NAME)
...
Coleção Nuclear - Distância de Gower e MLST DARwin
==================================================
```{r, eval = FALSE}
library(phangorn)
...
write.table(DataCarCCPheno3, file= here::here("output", "DadosCCPheno3.CSV"),
            quote = F, sep = ";", dec = ".")
```
