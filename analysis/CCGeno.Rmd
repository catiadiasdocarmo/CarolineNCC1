...
write.table(DataCarCCGeno4,
            file= here::here("output", "CCGenData", "DadosCCGeno1.CSV"),
            quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno5,
            file = here::here("output", "CCGenData", "DadosCCGeno2.CSV"),
            quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno6,
            file = here::here("output", "CCGenData", "DadosCCGeno3.CSV"), quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno7,
            file= here::here("output", "CCGenData", "DadosCCGeno4.CSV"), quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno8,
            file= here::here("output", "CCGenData", "DadosCCGeno5.CSV"), quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno9, file = here::here("output", "CCGenData", "DadosCCGeno6.CSV"), quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno10, file= here::here("output", "CCGenData", "DadosCCGeno7.CSV"), quote = F, sep = ";", dec = ".")
```
...
write.table(DataCarCCGeno11, file= here::here("output", "CCGenData", "DadosCCGeno8.CSV"), quote = F, sep = ";", dec = ".")
...
write.table(DataCarCCGeno12, file= here::here("output", "CCGenData", "DadosCCGeno9.CSV"), quote = F, sep = ";", dec = ".")
